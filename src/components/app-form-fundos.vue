    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 order-md-1 text-center text-md-left pr-md-5">
          <h1 class="mb-3">Fundos imobiliários - Cadastro</h1>
          <p class="lead mb-4"></p>
          <form method="" action="">
            ...
            <input class="form-control" type="text" />
            <br />
            <router-link to="/fundos" tag="button" class="btn btn-success"
              >Salvar</router-link
            >&nbsp; &nbsp;
            <router-link to="/fundos" tag="button" class="btn btn-danger"
              >Voltar</router-link
            >
          </form>
        </div>
